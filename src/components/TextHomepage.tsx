  ...
  return (
    <div className="px-8 py-12 bg-white text-black">
      ...
      <div className="space-y-6">
        ...
        <p className="text-lg">
          Alliez sécurité et esthétique grâce à nos modèles variés : styles
          classiques ou designs modernes avec des finitions uniques.
        </p>

        <p className="text-lg">
          Pensez aussi à l&apos;automatisation pour un confort optimal, avec nos
          motorisations adaptées. Retrouvez tous les accessoires assortis pour
          une harmonie parfaite dans votre jardin.
        </p>
