...
const CategoryNavItem = ({ category }: CategoryNavItemProps) => {
  return (
    <li className="pt-4 p-3 w-36 text-center text-wrap transition-all border-b-2 border-transparent hover:font-bold hover:border-b-2 hover:border-y-neutral-400">
      <a
        href={`
  ...
  return (
    <nav className="border-t md:border-b border-neutral-400 p-2 bg-transparent md:bg-neutral-500 text-neutral-50 font-semibold">
      <ul className="hidden md:flex flex-row justify-center">
        ...
        <div className="h-7 my-auto border-r border-neutral-500" />
        <CategoryNavItem
